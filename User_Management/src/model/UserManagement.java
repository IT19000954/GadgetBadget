...
public class UserManagement {
	...
	public String readUsers() {
		...
		try {
			...
			output = "<table border='1'><tr><th>User Name</th>" + "<th>User Type</th>"
					+ "<th>Password</th>" + "<th>Email</th>" + "<th>Phone</th>" + "<th>Address</th>" + "<th>Update</th><th>Remove</th></tr>";
	...
	public String insertUser(String userName,String userType,String Password,String Email ,String Phone,String Address) {
		String output = "";
		try {
			Connection con = connect();
			if (con == null) {
			...
			String query = " insert into user (`userID`,`userName`,`userType`,`Password`,`Email`,`Phone`,`Address`)" + " values (?, ?, ?, ?, ?, ?, ?)";
	...
	public String updateUser(String userID, String userName,String userType,String Password,String Email ,String Phone,String Address) {
		String output = "";
		try {
			Connection con = connect();
			if (con == null) {
